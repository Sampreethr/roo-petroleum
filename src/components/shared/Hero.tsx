    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          {/* Subtitle */}
          {subtitle && (
            <p className="text-[#F2601A] font-semibold text-sm sm:text-base uppercase tracking-wider mb-4 fade-in">
              {subtitle}
            </p>
          )}
          ...
          {/* Description */}
          {description && (
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed fade-in">
              {description}
            </p>
          )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto fade-in">
            <div className="text-center">
              <div className="text-3xl font-bold text-[#F2601A] mb-2">25+</div>
              <div className="text-gray-300 text-sm uppercase tracking-wide">Years Experience</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#F2601A] mb-2">500+</div>
              <div className="text-gray-300 text-sm uppercase tracking-wide">Satisfied Clients</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#F2601A] mb-2">24/7</div>
              <div className="text-gray-300 text-sm uppercase tracking-wide">Support Available</div>
            </div>
          </div>
        </div>
      </div>
